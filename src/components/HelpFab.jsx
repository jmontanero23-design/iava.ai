    ...
    <>
      ...
      {open && (
        <div className="fixed bottom-16 right-4 z-50 w-80 bg-slate-900 border border-slate-700 rounded shadow-xl p-3">
          ...
          <textarea value={q} onChange={e=>setQ(e.target.value)} placeholder="Ask about indicators, score, presets, scanning, backtests…" className="w-full h-20 input p-2 text-sm" />
